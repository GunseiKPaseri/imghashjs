...
const phash = (img, option = {}) => {
    var _a, _b, _c;
    const DCTSize = (_a = option.DCTSize) !== null && _a !== void 0 ? _a : PHASH_PRESET.DCTSize;
    const lowSize = (_b = option.lowSize) !== null && _b !== void 0 ? _b : PHASH_PRESET.lowSize;
    // const convertSequence = option.convertSequence ?? 'rg'
    const luma_c = (_c = option.luma) !== null && _c !== void 0 ? _c : PHASH_PRESET.luma;
